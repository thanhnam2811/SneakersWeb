        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                ...
                <nav class="d-flex align-items-center">
                    ...
                    <a href="#">Manage Brand<span class="lnr lnr-arrow-right"></span></a>
                    <a href="#">New Brand</a>
                </nav>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="login_form_inner">
                ...
                <form class="row login_form" action="contact_process.php" method="post" id="contactForm">
                    ...
                    <div class="col-md-12 form-group">
                        <input type="text" class="form-control" id="brandImage" name="brandImage" placeholder="Image URL" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Image URL'">
                    </div>
                    <div class="col-md-12 form-group">
                        <input type="text" class="form-control" id="brandEmail" name="brandEmail" placeholder="Brand Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Brand Email'">
                    </div>
                    <div class="col-md-12 form-group">
