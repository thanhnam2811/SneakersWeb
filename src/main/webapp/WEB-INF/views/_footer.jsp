...
<section class="brand-area section_gap">
    <div class="container">
        <c:if test="${listB == null}">
            <c:set var="listB" value="${DBBrandUtil.getAllBrand(requestScope.ATTRIBUTE_FOR_CONNECTION)}"/>
        </c:if>
        <div class="row">
            <c:forEach items="${listB}" var="b">
            <a class="col single-img" href="${pageContext.request.contextPath}/product?brand=${b.id}">
                <img class="img-fluid d-block mx-auto" src="${b.logo}" alt="Nike">
            </a>
            </c:forEach>
        </div>
    </div>
