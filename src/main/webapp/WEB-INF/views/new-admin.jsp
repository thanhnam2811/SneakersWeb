    ...
    <div class="container">
        <div class="col-lg-6">
            <div class="login_form_inner">
                <h3>Add new Admin</h3>
                <form class="row login_form" action="login-register?type=register" method="post" name="formRegister"
                      onsubmit="return checkInput()">
                    <div class="col-md-12 form-group">
                        <input type="text" class="form-control" name="_username" placeholder="Username" required
                               id="_username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
                    </div>
                    <div class="col-md-12 form-group">
                        <input type="password" class="form-control" name="_password" placeholder="Password" required
                               id="_password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
                    </div>
                    <div class="col-md-12 form-group">
                        <input type="password" class="form-control" name="_cpassword" placeholder="Confirm Password"
                               required id="_cpassword" onfocus="this.placeholder = ''"
                               onblur="this.placeholder = 'Confirm Password'">
                    </div>
                    <div class="col-md-12 form-group">
                        <input type="text" class="form-control" name="_fullname" placeholder="Full Name" required
                               id="_fullname" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Full Name'">
                    </div>
                    <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-12 form-group">
                        <input type="text" class="form-control" name="_address" placeholder="Address" required
                               id="_address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Address'">
                    </div>
                    <div class="col-md-12 form-group">
