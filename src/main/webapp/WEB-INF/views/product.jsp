        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                ...
                <nav class="d-flex align-items-center">
                    ...
                    <a href="${pageContext.request.contextPath}/product">Product<span
                            class="lnr lnr-arrow-right"></span></a>
                    <a href="${pageContext.request.contextPath}/product?brand=${brand}">${Brand.getNameBrand_ById(listB, brand)}</a>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-5">
                    ...
                    <li class="main-nav-list">
                        <a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false"
                           aria-controls="fruitsVegetable">
                            <span class="lnr lnr-arrow-right"></span>Fruits and Vegetables
            ...
            <div class="sidebar-categories">
                <div class="common-filter">
                    ...
                    <ul>
                        <li class="main-nav-list">
                            <a href="${pageContext.request.contextPath}/product" class="${brand == 0 ? "active" : ""}">
                                All brands
                            </a>
                        </li>
                        <c:forEach items="${listB}" var="b">
                            <li class="main-nav-list">
                                <a href="${pageContext.request.contextPath}/product?brand=${b.id}"
                                   class="${brand == b.id ? "active" : ""}">
                                        ${b.name}
                                </a>
                            </li>
                        </c:forEach>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
            ...
            <div class="filter-bar d-flex flex-wrap align-items-center">
                ...
                <div class="pagination">
                    <a href="${pageContext.request.contextPath}/product?page=${page - 1}&brand=${brand}"
                       class="prev-arrow">
                        <i class="fa fa-long-arrow-left" aria-hidden="false"></i>
                    </a>
                    <c:forEach var="p" begin="1" end="${maxPage}">
                        <a href="${pageContext.request.contextPath}/product?page=${p}&brand=${brand}"
                           class="${p == page ? "active" : "" }">
                                ${p}
                        </a>
                    </c:forEach>
